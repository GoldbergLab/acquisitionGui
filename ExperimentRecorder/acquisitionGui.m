...
% Last Modified by GUIDE v2.5 28-Jun-2013 12:27:08
...
acqdisplaydata.currChan4 = 0;
acqdisplaydata.currChan5 = 0;
acqdisplaydata.currChan6 = 0;
acqdisplaydata.currChan7 = 0;
acqdisplaydata.currChan8 = 0;
...
P.dispchan4 = []; %array of chans for 4th signal plot for each exper.
P.dispchan5 = []; %array of chans for 5th signal plot for each exper.
P.dispchan6 = []; %array of chans for 6th signal plot for each exper.
P.dispchan7 = []; %array of chans for 7th signal plot for each exper.
P.dispchan8 = []; %array of chans for 8th signal plot for each exper.
...
if(~dgd.bTrigOnSong(nExper))
    ...
    if(isempty(dgd.trigOnSongTimer))
        ...
        aa_checkinAppData(guifig, 'acqguidata', dgd);
        start(dgd.trigOnSongTimer); % this is where the error occurs - VG
    else
        aa_checkinAppData(guifig, 'acqguidata', dgd);
    end
...
% --- Executes on selection change in popupAudio1.
function popupAudio1_Callback(hObject, eventdata, handles)
% hObject    handle to popupAudio1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupAudio1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupAudio1
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
% --- Executes during object creation, after setting all properties.
function popupAudio1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupAudio1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupChannel4.
function popupChannel4_Callback(hObject, eventdata, handles)
% hObject    handle to popupChannel4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupChannel4 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupChannel4
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
value = get(handles.popupChannel4,'Value');
names = get(handles.popupChannel4,'String');
currName = names{value};
dash = strfind(currName, '-');
currChan = str2num(currName(1:dash(1)-1));
ddd.currChan4 = currChan;
...
% --- Executes during object creation, after setting all properties.
function popupChannel4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupChannel4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupChannel5.
function popupChannel5_Callback(hObject, eventdata, handles)
% hObject    handle to popupChannel5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupChannel5 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupChannel5
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
value = get(handles.popupChannel5,'Value');
names = get(handles.popupChannel5,'String');
currName = names{value};
dash = strfind(currName, '-');
currChan = str2num(currName(1:dash(1)-1));
ddd.currChan5 = currChan;

aa_checkinAppData(guifig, 'acqdisplaydata', ddd);
acqgui_updateDisplay(guifig);

% --- Executes during object creation, after setting all properties.
function popupChannel5_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupChannel5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupChannel6.
function popupChannel6_Callback(hObject, eventdata, handles)
% hObject    handle to popupChannel6 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupChannel6 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupChannel6
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
value = get(handles.popupChannel6,'Value');
names = get(handles.popupChannel6,'String');
currName = names{value};
dash = strfind(currName, '-');
currChan = str2num(currName(1:dash(1)-1));
ddd.currChan6 = currChan;

aa_checkinAppData(guifig, 'acqdisplaydata', ddd);
acqgui_updateDisplay(guifig);

% --- Executes during object creation, after setting all properties.
function popupChannel6_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupChannel6 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupChannel7.
function popupChannel7_Callback(hObject, eventdata, handles)
% hObject    handle to popupChannel7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupChannel7 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupChannel7
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
value = get(handles.popupChannel7,'Value');
names = get(handles.popupChannel7,'String');
currName = names{value};
dash = strfind(currName, '-');
currChan = str2num(currName(1:dash(1)-1));
ddd.currChan7 = currChan;

aa_checkinAppData(guifig, 'acqdisplaydata', ddd);
acqgui_updateDisplay(guifig);

% --- Executes during object creation, after setting all properties.
function popupChannel7_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupChannel7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupChannel8.
function popupChannel8_Callback(hObject, eventdata, handles)
% hObject    handle to popupChannel8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupChannel8 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupChannel8
guifig = get(hObject,'Parent');
[ddd, status] = aa_checkoutAppData(guifig, 'acqdisplaydata');
if(~status)
    warning('Unable to checkout ddd.');
...
value = get(handles.popupChannel8,'Value');
names = get(handles.popupChannel8,'String');
currName = names{value};
dash = strfind(currName, '-');
currChan = str2num(currName(1:dash(1)-1));
ddd.currChan8 = currChan;

aa_checkinAppData(guifig, 'acqdisplaydata', ddd);
acqgui_updateDisplay(guifig);

% --- Executes during object creation, after setting all properties.
function popupChannel8_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupChannel8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function addExperiment(guifig, exper)
...
for nExper = 1:length(dgd.expers)
    ...
    % Get a list of the non-null (-1) channels
    nonNullInChans = inChans;
    nonNullInChans(nonNullInChans==-1) = [];
    if(~isempty(intersect(nonNullInChans, dgd.experData(nExper).inChans)))
...
dgd.experData(experNdx).dddbackground.dispchan4 = inChans(min(length(inChans),5));
dgd.experData(experNdx).dddbackground.dispchan5 = inChans(min(length(inChans),6));
dgd.experData(experNdx).dddbackground.dispchan6 = inChans(min(length(inChans),7));
dgd.experData(experNdx).dddbackground.dispchan7 = inChans(min(length(inChans),8));
dgd.experData(experNdx).dddbackground.dispchan8 = inChans(min(length(inChans),9));
...
if(dgd.ce > 0 & ~bDeleted) %In case the experiment is the first one opened...
    ...
    dgd.experData(dgd.ce).dddbackground.dispchan4 = ddd.currChan4;
    dgd.experData(dgd.ce).dddbackground.dispchan5 = ddd.currChan5;
    dgd.experData(dgd.ce).dddbackground.dispchan6 = ddd.currChan6;
    dgd.experData(dgd.ce).dddbackground.dispchan7 = ddd.currChan7;
    dgd.experData(dgd.ce).dddbackground.dispchan8 = ddd.currChan8;
...
ddd.currChan4 = dgd.experData(dgd.ce).dddbackground.dispchan4;
ddd.currChan5 = dgd.experData(dgd.ce).dddbackground.dispchan5;
ddd.currChan6 = dgd.experData(dgd.ce).dddbackground.dispchan6;
ddd.currChan7 = dgd.experData(dgd.ce).dddbackground.dispchan7;
ddd.currChan8 = dgd.experData(dgd.ce).dddbackground.dispchan8;
...
for(nChan = 0:length(dgd.expers{dgd.ce}.sigCh))
    ...
    if(chan == ddd.currChan4)
        channdx4 = nChan+1;
    end
    if(chan == ddd.currChan5)
        channdx5 = nChan+1;
    end
    if(chan == ddd.currChan6)
        channdx6 = nChan+1;
    end
    if(chan == ddd.currChan7)
        channdx7 = nChan+1;
    end
    if(chan == ddd.currChan8)
        channdx8 = nChan+1;
    end
end
...
set(handles.popupChannel4,'String', chanstrings);
set(handles.popupChannel4,'Value',channdx4);
set(handles.popupChannel5,'String', chanstrings);
set(handles.popupChannel5,'Value',channdx5);
set(handles.popupChannel6,'String', chanstrings);
set(handles.popupChannel6,'Value',channdx6);
set(handles.popupChannel7,'String', chanstrings);
set(handles.popupChannel7,'Value',channdx7);
set(handles.popupChannel8,'String', chanstrings);
set(handles.popupChannel8,'Value',channdx8);
...
axes(handles.axesAudio);
ud = get(gca,'UserData');
%audio = ud.data; % an error occurs here - VG
audio = ud.signal; % mod by VG

% fs = ud.fs; % an error occurs here as well - VG
...
% --- Executes on key press with focus on buttonRecord and none of its controls.
function buttonRecord_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to buttonRecord (see GCBO)
...
% --- Executes during object creation, after setting all properties.
function axesSignal4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesSignal4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesSignal4


% --- Executes during object creation, after setting all properties.
function axesAudio1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesAudio1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesAudio1


% --- Executes during object creation, after setting all properties.
function axesSignal5_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesSignal5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesSignal5


% --- Executes during object creation, after setting all properties.
function axesSignal6_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesSignal6 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesSignal6


% --- Executes during object creation, after setting all properties.
function axesSignal8_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesSignal8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesSignal8
